...
class EmployeeController extends Controller
{
    ...
    public function overTimeIndex()
    {
     ...
     /** page overtime */
    public function getOwnsalary()
    {
        $user_id = Auth::User()->user_id;
        $ownsalary = DB::table('users')->join('staff_salaries', 'users.user_id', '=', 'staff_salaries.user_id')
        ->select('users.*', 'staff_salaries.*')
        ->where('staff_salaries.user_id',$user_id)->get();
        
        return view('employeepage/ownsalary',['ownsalary' => $ownsalary]);
    }
