                            ...
                            <div class="row"> 
                                <div class="col-sm-6"> 
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <label>Others</label>
                                        <input class="form-control @error('pf') is-invalid @enderror" type="number"  name="pf" id="pf" value="{{ old('pf') }}" placeholder="Enter others">
                                        @error('pf')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('overtime') is-invalid @enderror" type="number" name="overtime" id="overtime" value="{{ old('overtime') }}" placeholder="Enter Overtime">
                                        @error('overtime')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-sm-6">  
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('tardiness') is-invalid @enderror" type="number" name="tardiness" id="tardiness" value="{{ old('tardiness') }}" placeholder="Enter tardiness">
                                        @error('tardiness')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input class="form-control @error('absences') is-invalid @enderror" type="number" name="absences" id="absences" value="{{ old('absences') }}" placeholder="Enter absences">
                                        @error('absences')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('philhealth') is-invalid @enderror" type="number" name="philhealth" id="philhealth" value="{{ old('philhealth') }}" placeholder="Enter philhealth">
                                        @error('philhealth')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <label>HDMF</label>
                                        <input class="form-control @error('hdmf') is-invalid @enderror" type="number" name="hdmf" id="hdmf" value="{{ old('hdmf') }}" placeholder="Enter HDMF">
                                        @error('hdmf')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
